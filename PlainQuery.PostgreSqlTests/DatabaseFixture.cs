...
namespace PlainQuery.PostgreSqlTests
{
    public class DatabaseFixture: IAsyncLifetime
    {
        ...
        public static readonly DbExecutor Db = new($@"Server=127.0.0.1;Port=5432;Database={DatabaseName};User Id=postgres;Password=qwe123456;");
        
        public async Task InitializeAsync()
        {
            var connectionString = new NpgsqlConnectionStringBuilder(Db.ConnectionString) {Database = "postgres"}.ConnectionString;
            var db = new DbExecutor(connectionString);
