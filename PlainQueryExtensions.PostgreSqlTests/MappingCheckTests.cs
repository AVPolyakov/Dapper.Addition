...
namespace PlainQueryExtensions.PostgreSqlTests
{
    ...
    public class MappingCheckTests
    {
        ...
        public async Task EmptyDestinationType_ExceptionThrown()
        {
            ...
            Assert.Equal(@"Property 'PostId' not found in destination type. You can copy list of properties to destination type PlainQueryExtensions.PostgreSqlTests.PostInfo2:
        ...
        public async Task FieldTypeMismatch_ExceptionThrown()
        {
            ...
            Assert.Equal(@"Type of field 'PostId' does not match. Field type is 'long' in destination and `int?` in query. You can copy list of properties to destination type PlainQueryExtensions.PostgreSqlTests.PostInfo3:
        public int? PostId { get; set; }
        public string Text { get; set; }
        public DateTime? CreationDate { get; set; }",
                exception.Message);
        ...
        public async Task FieldTypeMismatch_Insert_ExceptionThrown()
        {
            ...
            Assert.Equal(@"Type of field 'PostId' does not match. Field type is 'long' in destination and `int` in query. You can copy list of properties to destination type PlainQueryExtensions.PostgreSqlTests.Namaspace2.Post:
        public int PostId { get; set; }
        public string Text { get; set; }
        public DateTime CreationDate { get; set; }",
                exception.Message);
